        ...
        >
          ...
          <TextInput
            ...
            help={
              <>
                <p>
                  A SEL expression that determines which stream(s) to precache
                  for the next episode. Should evaluate to a list of streams.
                </p>
                <p className="mt-2">
            ...
            help={
              <>
                <p>
                  ...
                  Should evaluate to a list of streams — all streams in the
                  result will have an HTTP request sent to their URLs.
                </p>
                <p className="mt-2">
                  <strong>Examples:</strong>
                </p>
